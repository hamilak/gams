...
const MainInformation = () => {
    // Function to handle smooth scrolling to the "ScholarshipInformation" section
    const handleLearnMoreClick = () => {
        const scholarshipSection = document.getElementById('scholarship-information');
            ...
            >
                ...
                <div className='relative px-10 md:w-3/5 sm:w-full w-4/5'>
                    ...
                    <div className='flex justify-center gap-10 mt-6'>
                        ...
                        <button className='bg-green-700 p-3 text-white rounded-md font-bold'>Apply Now</button>
                    </div>
                    <div className=' mt-4'>
